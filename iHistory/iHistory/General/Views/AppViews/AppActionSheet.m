...
-(void)showActionSheetInView:(UIView *)inView withTitleArray:(NSArray *)titleArray actionBlock:(AppActionSheetBlock )actionBlock
{
    ...
    for (int i=0; i<titleArray.count; i++)
    {
        ...
        titleButton.tag = i;
        [titleButton setBackgroundImage:UIImageForName(@"trans_btn") forState:UIControlStateNormal];
        [titleButton setBackgroundImage:UIImageForName(@"trans_btn_pre") forState:UIControlStateHighlighted];
