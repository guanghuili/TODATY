...
- (NSString*)platformString
{
    ...
    if ([platform isEqualToString:@"iPhone3,2"])   return@"iPhone 4";//Verizon iPhone 4
    if ([platform isEqualToString:@"iPhone3,3"])   return@"iPhone 4";//iPhone 4 (CDMA)
...
-(BOOL)isSmallPHONE
{
    BOOL smallPHONE =  [UIApplication sharedApplication].keyWindow.frame.size.height <= 480;
